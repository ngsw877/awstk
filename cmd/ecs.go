...
func init() {
	...
	// execコマンドのフラグを設定
	ecsExecCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsExecCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsExecCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
	ecsExecCmd.MarkFlagsRequiredTogether("cluster", "service")

	// startコマンドのフラグを設定
	ecsStartCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsStartCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsStartCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
	ecsStartCmd.MarkFlagsRequiredTogether("cluster", "service")

	// stopコマンドのフラグを設定
	ecsStopCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsStopCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsStopCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
	ecsStopCmd.MarkFlagsRequiredTogether("cluster", "service")

	// runコマンドのフラグを設定
	ecsRunCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsRunCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsRunCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
	ecsRunCmd.MarkFlagsRequiredTogether("cluster", "service")

	// redeployコマンドのフラグを設定
	ecsRedeployCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsRedeployCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsRedeployCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
	ecsRedeployCmd.MarkFlagsRequiredTogether("cluster", "service")

	// statusコマンドのフラグを設定
	ecsStatusCmd.Flags().StringVarP(&stackName, "stack-name", "S", "", "CloudFormationスタック名")
	...
	ecsStatusCmd.MarkFlagsMutuallyExclusive("stack-name", "cluster")
	ecsStatusCmd.MarkFlagsMutuallyExclusive("stack-name", "service")
